<!--   Core JS Files   -->
<script
    src="{{ asset('material-kit') }}/assets/js/core/popper.min.js"
    type="text/javascript"
></script>
<script
    src="{{ asset('material-kit') }}/assets/js/core/bootstrap.min.js"
    type="text/javascript"
></script>
...
<script
    src="{{ asset('material-kit') }}/assets/js/material-kit.min.js?v=3.0.4"
    type="text/javascript"
></script>
<script>
