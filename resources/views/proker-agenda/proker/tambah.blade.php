                    ...
                    >
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-sm-12 col-12">
                                <div class="mb-3">
                                    <label
                                        for="name"
                                        class="form-label"
                                    >Nama Acara <small class="text-danger">*</small></label>
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="name"
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    <label
                                        for="biro_department_id"
                                        class="form-label"
                                    >Biro / Department<small class="text-danger">*</small></label>
                                    <select
                                        class="form-select"
                                        id="biro_department_id"
                                        name="biro_department_id"
                                    >
                                        <option value="pilih">--Pilih--</option>
                                        @foreach ($biro_departments as $key => $biro_department)
                                        <option value="{{ $biro_department->id }}">{{ $biro_department->name }}</option>
                                        @endforeach
                                    </select>
